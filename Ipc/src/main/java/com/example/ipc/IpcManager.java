...
public class IpcManager {
    ...
    private IServiceAidlInterface mServer;
    private IBinder.DeathRecipient mDeathRecipient;
    private IResultInterface.Stub mClientInterface;
    ...
    private void connectService() {
        if (mConnection == null) {
            mConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    ...
                    mServer = IServiceAidlInterface.Stub.asInterface(service);
                    //往服务端注入接口
                    try {
                        mServer.addCallBack(mClientInterface);
                        Log.e("1111","1111");
        ...
        if (mClientInterface == null){
            mClientInterface = new IResultInterface.Stub(){
